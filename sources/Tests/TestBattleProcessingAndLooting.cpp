#include "TestBattleProcessingAndLooting.hpp"
...
URHO3D_DEFINE_APPLICATION_MAIN (Tests::TestBattleProcessingAndLootingApplication)
namespace Tests
{
TestBattleProcessingAndLootingApplication::TestBattleProcessingAndLootingApplication (Urho3D::Context *context) :
    Urho3D::Application (context)
{

}

TestBattleProcessingAndLootingApplication::~TestBattleProcessingAndLootingApplication ()
{

}

void TestBattleProcessingAndLootingApplication::Setup ()
{
    engineParameters_ ["FullScreen"] = false;
    engineParameters_ ["WindowResizable"] = true;
    engineParameters_ ["LogName"] = "TestBattleProcessingAndLooting.log";
    engineParameters_ ["WindowTitle"] = "TestBattleProcessingAndLooting";
    engineParameters_ ["ResourcePrefixPaths"] = "..;.";
}

void TestBattleProcessingAndLootingApplication::Start ()
{
...
void TestBattleProcessingAndLootingApplication::Stop ()
{
